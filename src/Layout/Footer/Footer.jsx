...
const Footer = () => {
  return (
    <div className='bg-black py-10'>
               <Link to='/' className=" text-xl"><img src={logo} alt="" className='w-12 rounded-full ml-10 ' /></Link>
        
      <footer className="footer sm:footer-horizontal px-10 py-5 bg-black text-white">
      ...
      <footer className="footer  border-base-300 border-t px-10 py-4 bg-black text-white">
        ...
        <nav className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            <Link to='https://x.com/arafat1abir'>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
