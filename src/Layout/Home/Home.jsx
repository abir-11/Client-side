  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='flex justify-center mt-10 '>
        <Link to='/allCrops'><button className="btn mx-auto btn-outline hover:scale-105 transition  ease-in bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-medium rounded-xl shadow hover:shadow-xl">
          View All
        </button></Link>
      </div>
      <div>
      ...
      <div>
        <section className="bg-white pb-16 px-6 md:px-16">
            ...
            <div>
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className={`rounded-xl border overflow-hidden transition-all duration-300 hover:bg-green-800 hover:text-white ${openIndex === index ? "bg-green-800 text-white" : "bg-white"
                      }`}
                  >
                    <button
      ...
      <section className="pt-10 sm:py-14 md:py-16 bg-green-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 text-center">
      ...
      <section className="pb-10 rounded-2xl my-16  max-w-6xl px-10 mx-auto shadow-xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="p-6 bg-white rounded-xl border shadow hover:bg-green-800 hover:text-white hover:font-bold">Organic Marketplace</div>
          <div className="p-6 bg-white rounded-xl border shadow hover:bg-green-800 hover:text-white hover:font-bold">Smart Farming Guide</div>
          <div className="p-6 bg-white rounded-xl border shadow hover:bg-green-800 hover:text-white hover:font-bold">Farmer Community</div>
        </div>
      </section>
